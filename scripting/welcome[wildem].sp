...
public Action Timer_DelaySpawn(Handle timer, any data)
{
	...
	PrintToChat(client, " \x07[Wildem] \x01Reméljük örömteli perceket okozhatunk neked.");
	PrintToChat(client, " \x07[Wildem] \x01Weboldal: https://www.wildem.hu/");
	PrintToChat(client, " \x07[Wildem] \x01Discord: https://discord.gg/Em9DMjhdkG");
